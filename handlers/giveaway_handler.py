...
async def giveaway_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "🔥 **Актуальная информация о GiveAway**\n\n"
        "✨ **Daily** — 🧏🏻‍♀️ приз 15$ в день\n"
        "🐦‍🔥 Топ дня: пост, коммент, тег - отметка @трикс\n\n"
        "💫 **Weekly** — 🧏‍♂️ приз 55$ в неделю\n"
        "🐦‍🔥 Roll, NTM, TopWeek, 7TT\n\n"
        "🌟 **Monthly** — 🧏🏼 приз 220$+ в месяц\n"
        "🐦‍🔥 Member 100$, 🎫 TrixTicket 100$, 🙅 Каталог услуг - 20$\n\n"
        "⚡️ **Quests** — 🕺 Задание = 🪙 Деньги\n\n"
        "👄 Информация обновляется в группе: [Budapest Partners](https://t.me/budapestpartners)\n"
